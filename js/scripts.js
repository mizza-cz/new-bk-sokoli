...
!(function (e, t) {
  ...
  var o = 'undefined' != typeof window,
    ...
    z = o && 'IntersectionObserver' in window,
    i = o && 'classList' in document.createElement('p'),
    R = {
      elements_selector: 'img',
      container: s || o ? document : null,
      threshold: 300,
      thresholds: null,
      data_src: 'src',
      data_srcset: 'srcset',
  ...
  function n(e, t, i) {
    (t = g + t), null === i ? e.removeAttribute(t) : e.setAttribute(t, i);
  }
  function r(e, t) {
    (e.loadingCount += t),
      0 === e._elements.length && 0 === e.loadingCount && k(e._settings.callback_finish, e);
  }
  function a(e) {
  ...
  function l(e, t) {
    T(e, 'sizes', b(e, t.data_sizes)),
      T(e, 'srcset', b(e, t.data_srcset)),
      T(e, 'src', b(e, t.data_src));
  }
  function c(e, t) {
    i
  ...
  function p(e, t, i) {
    u(e, C, t), u(e, A, t), u(e, E, i);
  }
  function h(e, t, i) {
    var n = i._settings,
      o = t ? n.class_loaded : n.class_error,
      t = t ? n.callback_loaded : n.callback_error,
      e = e.target;
    c(e, n.class_loading), $(e, o), k(t, e, i), r(i, -1);
  }
  function H(e, t) {
  ...
  function f(e, t, i) {
    var n = t._settings;
    (!i && _(e)) ||
      (-1 < U.indexOf(e.tagName) && (N(e, t), $(e, n.class_loading)),
      j(e, t),
      q(e),
      k(n.callback_reveal, e, t),
      k(n.callback_set, e, t));
  }
  function m(e, t) {
    return (
  ...
  function t(e, t) {
    var i, n;
    (this._settings = _extends({}, R, e)),
      (this.loadingCount = 0),
      (i = this),
      z &&
        (i._observer = new IntersectionObserver(function (e) {
          e.forEach(function (e) {
            return (B(e) ? W : Z)(e.target, e, i);
          });
        }, G(i._settings))),
      this.update(t),
      (n = this),
  ...
  var g = 'data-',
    ...
    k = function (e, t, i, n) {
      e && (void 0 !== n ? e(t, i, n) : void 0 !== i ? e(t, i) : e(t));
    },
    T = function (e, t, i) {
    ...
    j = function (e, t) {
      ...
      (e = b((t = e), (o = n).data_src)),
        (o = b(t, o.data_bg)),
        e && (t.style.backgroundImage = 'url("'.concat(e, '")')),
    ...
    N = function (i, n) {
      ...
      (s = o), d((e = i), C, (t = r)), d(e, A, t), d(e, E, s);
    },
    U = ['IMG', 'IFRAME', 'VIDEO'],
    W = function (e, t, i) {
      var n = i._settings;
      k(n.callback_enter, e, t, i), (n.load_delay ? H : O)(e, i);
    },
    O = function (e, t) {
      var i = t._observer;
      f(e, t), i && t._settings.auto_unobserve && i.unobserve(e);
    },
    Z = function (e, t, i) {
      var n = i._settings;
      k(n.callback_exit, e, t, i), n.load_delay && I(e);
    },
    I = function (e) {
      var t = S(e);
      t && (clearTimeout(t), x(e, null));
    },
    B = function (e) {
  ...
  if (
    ((t.prototype = {
      update: function (e) {
        var t,
          i = this,
          n = this._settings;
        (this._elements = m(e, n)),
          s || !this._observer
            ? this.loadAll()
            : (n.use_native &&
                'loading' in HTMLImageElement.prototype &&
                ((t = this)._elements.forEach(function (e) {
                  -1 !== K.indexOf(e.tagName) && (e.setAttribute('loading', 'lazy'), f(e, t));
                }),
                (this._elements = m(e, n))),
    ...
    if (L)
      if (L.length) for (var M, P = 0; (M = L[P]); P += 1) e(D, M);
      else e(D, L);
  }
  return t;
}),
  ...
  (function (e, t) {
    ...
    function (b) {
      ...
      function r(e) {
        ...
        for (var t, i = String(e), n = i.length, o = -1, s = '', r = i.charCodeAt(0); ++o < n; ) {
          if (0 === (t = i.charCodeAt(o)))
      ...
      function k(e, t, i, n) {
        t.emitEvents &&
          ...
          ((t = new CustomEvent(e, { bubbles: !0, detail: { anchor: i, toggle: n } })),
      ...
      return function (o, e) {
        function t(e) {
          if (
            ...
            'closest' in e.target &&
            (s = e.target.closest(o)) &&
            'a' === s.tagName.toLowerCase() &&
            !e.target.closest(g.ignore) &&
            s.hostname === b.location.hostname &&
            s.pathname === b.location.pathname &&
            /#/.test(s.href)
          ) {
            var t;
            try {
            ...
            (t = t || '#top' !== i ? t : document.documentElement) &&
              ...
              history.replaceState &&
                ...
                ((n = (n = b.location.hash) || ''),
                history.replaceState(
                  { smoothScroll: JSON.stringify(i), anchor: n || b.pageYOffset },
                  document.title,
                  n || b.location.href,
                )),
              w.animateScroll(t, s));
        ...
        w.animateScroll = function (n, o, e) {
          w.cancelScroll();
          var s,
            r,
            a,
            ...
            e = m || !n.tagName ? null : n;
          (m || e) &&
            ((s = b.pageYOffset),
            f.header && !v && (v = document.querySelector(f.header)),
            (t = (t = v) ? parseInt(b.getComputedStyle(t).height, 10) + t.offsetTop : 0),
            (l = m
              ? n
              : (function (e, t, i, n) {
                  var o = 0;
                  ...
                  return (
                    (o = Math.max(o - t - i, 0)), (o = n ? Math.min(o, x() - b.innerHeight) : o)
                  );
                })(
                  e,
                  t,
                  parseInt('function' == typeof f.offset ? f.offset(n, o) : f.offset, 10),
                  f.clip,
                )),
            (c = l - s),
            (d = x()),
            (u = 0),
            (t = (e = f).speedAsDuration ? e.speed : Math.abs((c / 1e3) * e.speed)),
            (p =
            ...
            (h = function (e) {
              ...
              (u += e - (r = r || e)),
                (a =
                  s +
                  c *
                    ((i = a = 1 < (a = 0 === p ? 0 : u / p) ? 1 : a),
                    'easeInQuad' === f.easing && (t = i * i),
                    'easeOutQuad' === f.easing && (t = i * (2 - i)),
                    'easeInOutQuad' === f.easing && (t = i < 0.5 ? 2 * i * i : (4 - 2 * i) * i - 1),
                    'easeInCubic' === f.easing && (t = i * i * i),
                    'easeOutCubic' === f.easing && (t = --i * i * i + 1),
                    'easeInOutCubic' === f.easing &&
                      (t = i < 0.5 ? 4 * i * i * i : (i - 1) * (2 * i - 2) * (2 * i - 2) + 1),
                    'easeInQuart' === f.easing && (t = i * i * i * i),
                    'easeOutQuart' === f.easing && (t = 1 - --i * i * i * i),
                    'easeInOutQuart' === f.easing &&
                      (t = i < 0.5 ? 8 * i * i * i * i : 1 - 8 * --i * i * i * i),
                    'easeInQuint' === f.easing && (t = i * i * i * i * i),
                    'easeOutQuint' === f.easing && (t = 1 + --i * i * i * i * i),
                    'easeInOutQuint' === f.easing &&
                      (t = i < 0.5 ? 16 * i * i * i * i * i : 1 + 16 * --i * i * i * i * i),
                    (t = f.customEasing ? f.customEasing(i) : t) || i)),
                b.scrollTo(0, Math.floor(a)),
                (t = l),
                (i = b.pageYOffset),
                (!(a == t || i == t || (s < t && b.innerHeight + i) >= d) ||
                  (w.cancelScroll(!0), S(n, t, m), k('scrollStop', f, n, o), (y = r = null))) &&
                  ((y = b.requestAnimationFrame(h)), (r = e));
            }),
            ...
            'matchMedia' in b && b.matchMedia('(prefers-reduced-motion)').matches
              ? S(n, Math.floor(l), !1)
              : (k('scrollStart', f, n, o), w.cancelScroll(!0), b.requestAnimationFrame(h)));
        };
        if (
          ((w.destroy = function () {
            g &&
              (document.removeEventListener('click', t, !1),
              b.removeEventListener('popstate', i, !1),
              w.cancelScroll(),
              (y = v = s = g = null));
          }),
          'querySelector' in document &&
            'addEventListener' in b &&
            'requestAnimationFrame' in b &&
            'closest' in b.Element.prototype)
        )
          return (
            w.destroy(),
            (g = _(T, e || {})),
            ...
            g.updateURL && g.popstate && b.addEventListener('popstate', i, !1),
            w
          );
  ...
  (function (i) {
    ...
    ((d = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : d) && d.requirejs) ||
      (d ? (i = d) : (d = {}),
      (m = {}),
      (g = {}),
      (v = {}),
      ...
      (s = function (e, t, i, n) {
        ...
        if ('undefined' == d || 'function' == d) {
          for (
            t = !t.length && i.length ? ['require', 'exports', 'module'] : t, a = 0;
            a < t.length;
            a += 1
          )
            if ('require' === (s = (r = h(t[a], u)).f)) c[a] = f.require(e);
            else if ('exports' === s) (c[a] = f.exports(e)), (l = !0);
            else if ('module' === s) o = c[a] = f.module(e);
            else if (b(m, s) || b(g, s) || b(y, s)) c[a] = x(s);
            else {
      ...
      (e =
        ...
        r =
          function (e, t, i, n, o) {
            if ('string' == typeof e) return f[e] ? f[e](t) : x(h(e, S(t)).f);
            if (!e.splice) {
      ...
      d.define('select2/utils', ['jquery'], function (s) {
        var n = {};
        function c(e) {
          var t,
            i = e.prototype,
        ...
        (n.Extend = function (e, t) {
          ...
          return (
            (o.prototype = t.prototype), (e.prototype = new o()), (e.__super__ = t.prototype), e
          );
        }),
          (n.Decorate = function (n, o) {
            ...
            function s() {
              ...
              0 < t && (e.call(arguments, n.prototype.constructor), (i = o.prototype.constructor)),
            ...
            for (var a = 0; a < e.length; a++) {
              ...
              s.prototype[l] = (function (e) {
                var t = function () {},
                  i = (e in s.prototype && (t = s.prototype[e]), o.prototype[e]);
                return function () {
          ...
          (n.GetUniqueElementId = function (e) {
            ...
            return (
              null == t &&
                ((t = e.id
                  ? 'select2-data-' + e.id
                  : 'select2-data-' + (++i).toString() + '-' + n.generateChars(4)),
                e.setAttribute('data-select2-id', t)),
              t
            );
          }),
          (n.StoreData = function (e, t, i) {
            (e = n.GetUniqueElementId(e)),
              n.__cache[e] || (n.__cache[e] = {}),
              (n.__cache[e][t] = i);
          }),
          (n.GetData = function (e, t) {
            var i = n.GetUniqueElementId(e);
            return t
              ? n.__cache[i] && null != n.__cache[i][t]
                ? n.__cache[i][t]
                : s(e).data(t)
              : n.__cache[i];
          }),
      ...
      d.define('select2/results', ['jquery', './utils'], function (u, p) {
        function n(e, t, i) {
          (this.$element = e),
            (this.data = i),
            (this.options = t),
        ...
        return (
          ...
          (n.prototype.option = function (e) {
            ...
            for (i in (((null != e.element && o.call(e.element, ':disabled')) ||
          ...
          (n.prototype.bind = function (t, e) {
            ...
            this.$results.attr('id', i),
              ...
              t.on('select', function () {
                t.isOpen() &&
                  (o.setClasses(), o.options.get('scrollAfterSelect') && o.highlightFirstItem());
              }),
              ...
              t.on('results:previous', function () {
                ...
                n <= 0 ||
                  ((e = n - 1),
                  0 === t.length && (e = 0),
                  (n = i.eq(e)).trigger('mouseenter'),
                  (t = o.$results.offset().top),
                  (i = n.offset().top),
                  (n = o.$results.scrollTop() + (i - t)),
                  0 === e ? o.$results.scrollTop(0) : i - t < 0 && o.$results.scrollTop(n));
              }),
              t.on('results:next', function () {
                ...
                n >= i.length ||
                  ...
                  0 === n ? o.$results.scrollTop(0) : t < i && o.$results.scrollTop(e));
              }),
          ...
          (n.prototype.ensureHighlightVisible = function () {
            ...
            0 !== o.length &&
              ...
              (t = o.offset().top),
              (i = this.$results.scrollTop() + (t - n)),
              (n = t - n),
              (i -= 2 * o.outerHeight(!1)),
              e <= 2
                ? this.$results.scrollTop(0)
                : (n > this.$results.outerHeight() || n < 0) && this.$results.scrollTop(i));
          }),
            ...
            (o.prototype.update = function (e) {
              ...
              0 !== e.length
                ? ((i = e[0]),
                  ...
                  (e = this.display(i, t)),
                  t.empty().append(e),
                  (i = i.title || i.text) ? t.attr('title', i) : t.removeAttr('title'))
                : this.clear();
            }),
            o
          );
        ...
        return (
          ...
          (s.prototype.update = function (e) {
            if ((this.clear(), 0 !== e.length)) {
              for (
                var t = [],
                  i = this.$selection.find('.select2-selection__rendered').attr('id') + '-choice-',
                  n = 0;
                n < e.length;
                n++
              ) {
                var o = e[n],
                  ...
                  l =
                    (o.id ? (a += o.id) : (a += c.generateChars(4)),
                    s.find('.select2-selection__choice__display').append(r).attr('id', a),
                    o.title || o.text);
                l && s.attr('title', l),
                  (r = this.options.get('translations').get('removeItem')),
                  (l = s.find('.select2-selection__choice__remove')).attr('title', r()),
                  l.attr('aria-label', r()),
                  l.attr('aria-describedby', a),
                  c.StoreData(s[0], 'data', o),
                  t.push(s);
              }
              ...
              if (!this.isDisabled()) {
                ...
                if (0 !== i.length) {
                  ...
                  var n = a.GetData(i[0], 'data'),
                    o = this.$element.val(),
                    s = (this.$element.val(this.placeholder.id), { data: n });
                  if ((this.trigger('clear', s), s.prevented)) this.$element.val(o);
                  else {
                    for (var r = 0; r < n.length; r++)
                      if (((s = { data: n[r] }), this.trigger('unselect', s), s.prevented))
            ...
            (e.prototype.update = function (e, t) {
              ...
              e.call(this, t),
                ...
                0 < this.$selection.find('.select2-selection__placeholder').length ||
                  0 === t.length ||
                  ((i = this.$selection.find('.select2-selection__rendered').attr('id')),
        ...
        return (
          ...
          (e.prototype.bind = function (e, t, i) {
            var n = this,
              ...
              s = t.id + '-container';
            e.call(this, t, i),
              n.$search.attr('aria-describedby', s),
              t.on('open', function () {
              ...
              t.on('results:focus', function (e) {
                e.data._resultId
                  ? n.$search.attr('aria-activedescendant', e.data._resultId)
                  : n.$search.removeAttr('aria-activedescendant');
              }),
              ...
              this.$selection.on('keydown', '.select2-search--inline', function (e) {
                ...
                e.stopPropagation(),
                  ...
                  e.which === l.BACKSPACE &&
                    '' === n.$search.val() &&
                    0 < (t = n.$selection.find('.select2-selection__choice').last()).length &&
                    ((t = a.GetData(t[0], 'data')), n.searchRemoveChoice(t), e.preventDefault());
              }),
      ...
      d.define('select2/selection/selectionCss', ['../utils'], function (i) {
        ...
        return (
          (e.prototype.render = function (e) {
            var t = e.call(this);
            return (
              -1 !== (e = this.options.get('selectionCssClass') || '').indexOf(':all:') &&
                ((e = e.replace(':all:', '')), i.copyNonInternalCssClasses(t[0], this.$element[0])),
              t.addClass(e),
              t
            );
          }),
            ...
            e.call(this, t, i),
              t.on('*', function (e, t) {
                ...
                -1 !== o.indexOf(e) &&
                  ...
                  n.$element.trigger(i),
                  -1 !== s.indexOf(e) && (t.prevented = i.isDefaultPrevented()));
              });
          }),
          e
        );
        ...
        return (
          ...
          (n.prototype.generateResultId = function (e, t) {
            return (
              (e = e.id + '-result-'),
              (e += i.generateChars(4)),
              null != t.id ? (e += '-' + t.id.toString()) : (e += '-' + i.generateChars(4)),
              e
            );
          }),
          n
        ...
        return (
          ...
          (i.prototype.select = function (o) {
            var e,
              s = this;
            if (
              ((o.selected = !0), null != o.element && 'option' === o.element.tagName.toLowerCase())
            )
              return (
                (o.element.selected = !0), void this.$element.trigger('input').trigger('change')
              );
          ...
          (i.prototype.unselect = function (o) {
            ...
            if (this.$element.prop('multiple')) {
              if (
                ((o.selected = !1),
                null != o.element && 'option' === o.element.tagName.toLowerCase())
              )
                return (
                  (o.element.selected = !1), void this.$element.trigger('input').trigger('change')
                );
              this.current(function (e) {
          ...
          (i.prototype.query = function (t, e) {
            ...
            this.$element.children().each(function () {
              ...
              ('option' !== this.tagName.toLowerCase() &&
                ...
                ((e = l(this)), (e = n.item(e)), null !== (e = n.matches(t, e)) && i.push(e));
            }),
              e({ results: i });
          }),
      ...
      d.define('select2/data/ajax', ['./array', '../utils', 'jquery'], function (e, t, s) {
        function i(e, t) {
            ...
            return s.extend(
              {},
              {
                ...
                transport: function (e, t, i) {
                  return (e = s.ajax(e)).then(t), e.fail(i), e;
                },
              },
              e,
              !0,
              ...
              null != c.term && null == c.page
                ? e.call(this, c, function e(t, i) {
                    for (var n = t.results, o = 0; o < n.length; o++) {
                      ...
                      if ((s.text || '').toUpperCase() === (c.term || '').toUpperCase() || r)
                        return !i && ((t.data = n), void d(t));
                    }
                    if (i) return !0;
                    var a,
                      l = u.createTag(c);
      ...
      d.define('select2/data/tokenizer', ['jquery'], function (c) {
        ...
        return (
          (e.prototype.bind = function (e, t, i) {
            e.call(this, t, i),
              (this.$search =
                t.dropdown.$search || t.selection.$search || i.find('.select2-search__field'));
          }),
            ...
            var n = this,
              o =
                ...
                this.tokenizer(t, this.options, function (e) {
                  var t,
                    i = n._normalizeItem(e);
                  n.$element.find('option').filter(function () {
                    return c(this).val() === i.id;
                  }).length ||
                    ((t = n.option(i)).attr('data-select2-tag', !0),
                    n._removeOldTags(),
                    n.addOptions([t])),
                    n.trigger('select', { data: (t = i) });
                }));
            o.term !== t.term &&
              (this.$search.length && (this.$search.val(o.term), this.$search.trigger('focus')),
              (t.term = o.term)),
              e.call(this, t, i);
          }),
      ...
      d.define('select2/dropdown/search', ['jquery'], function (s) {
        function e() {}
        return (
          (e.prototype.render = function (e) {
            var t = e.call(this),
            ...
            e.call(this, t, i),
              ...
              t.on('results:all', function (e) {
                (null != e.query.term && '' !== e.query.term) ||
                  (n.showSearch(e)
                    ? n.$searchContainer[0].classList.remove('select2-search--hide')
                    : n.$searchContainer[0].classList.add('select2-search--hide'));
              }),
              t.on('results:focus', function (e) {
                e.data._resultId
                  ? n.$search.attr('aria-activedescendant', e.data._resultId)
      ...
      d.define('select2/dropdown/attachBody', ['jquery', '../utils'], function (d, r) {
        function e(e, t, i) {
        ...
        return (
          ...
          (e.prototype._attachPositioningHandler = function (e, t) {
            ...
            (t = this.$container.parents().filter(r.hasScroll)).each(function () {
          ...
          (e.prototype._positionDropdown = function () {
            var e = d(window),
              ...
              r = ((s.top = o.top), (s.bottom = o.top + s.height), this.$dropdown.outerHeight(!1)),
              a = e.scrollTop(),
              l = e.scrollTop() + e.height(),
              c = a < o.top - r,
              e = l > o.bottom + r,
              a = { left: o.left, top: s.bottom };
            'static' === (l = this.$dropdownParent).css('position') && (l = l.offsetParent()),
              (o = { top: 0, left: 0 }),
              (d.contains(document.body, l[0]) || l[0].isConnected) && (o = l.offset()),
              (a.top -= o.top),
              (a.left -= o.left),
              t || i || (n = 'below'),
              e || !c || t ? !c && e && t && (n = 'below') : (n = 'above'),
              ('above' == n || (t && 'below' !== n)) && (a.top = s.top - o.top - r),
              null != n &&
        ...
        return (
          ...
          (e.prototype._handleSelectOnClose = function (e, t) {
            ...
            (i = this.getHighlightedResults()).length < 1 ||
              (null != (i = n.GetData(i[0], 'data')).element && i.element.selected) ||
      ...
      d.define('select2/dropdown/dropdownCss', ['../utils'], function (i) {
        ...
        return (
          (e.prototype.render = function (e) {
            var t = e.call(this);
            return (
              -1 !== (e = this.options.get('dropdownCssClass') || '').indexOf(':all:') &&
                ((e = e.replace(':all:', '')), i.copyNonInternalCssClasses(t[0], this.$element[0])),
              t.addClass(e),
              t
            );
        ...
        function (
          ...
          return (
            (i.prototype.apply = function (e) {
              ...
              null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter &&
                (null != e.ajax
                  ...
                  ? (e.dataAdapter = v)
                  : (e.dataAdapter = g),
                0 < e.minimumInputLength && (e.dataAdapter = f.Decorate(e.dataAdapter, _)),
                0 < e.maximumInputLength && (e.dataAdapter = f.Decorate(e.dataAdapter, x)),
                0 < e.maximumSelectionLength && (e.dataAdapter = f.Decorate(e.dataAdapter, S)),
                e.tags && (e.dataAdapter = f.Decorate(e.dataAdapter, w)),
                (null == e.tokenSeparators && null == e.tokenizer) ||
                  (e.dataAdapter = f.Decorate(e.dataAdapter, b))),
                null == e.resultsAdapter &&
                  ((e.resultsAdapter = s),
                  null != e.ajax && (e.resultsAdapter = f.Decorate(e.resultsAdapter, C)),
                  null != e.placeholder && (e.resultsAdapter = f.Decorate(e.resultsAdapter, $)),
                  e.selectOnClose && (e.resultsAdapter = f.Decorate(e.resultsAdapter, O)),
                  e.tags && (e.resultsAdapter = f.Decorate(e.resultsAdapter, L))),
                null == e.dropdownAdapter &&
                  ...
                  e.closeOnSelect && (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, I)),
                  null != e.dropdownCssClass &&
                    (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, D)),
                ...
                null == e.selectionAdapter &&
                  ...
                  e.allowClear && (e.selectionAdapter = f.Decorate(e.selectionAdapter, d)),
                  e.multiple && (e.selectionAdapter = f.Decorate(e.selectionAdapter, u)),
              ...
              this.defaults = {
                ...
                matcher: function e(t, i) {
                  ...
                  if (i.children && 0 < i.children.length) {
                    for (var n = l.extend(!0, {}, i), o = i.children.length - 1; 0 <= o; o--)
                      null == e(t, i.children[o]) && n.children.splice(o, 1);
            ...
            (i.prototype._resolveLanguage = function (e) {
              ...
              for (var t, i = Array.isArray(e) ? e : [e], n = [], o = 0; o < i.length; o++)
                n.push(i[o]),
                  'string' == typeof i[o] &&
                    0 < i[o].indexOf('-') &&
                    ((t = i[o].split('-')[0]), n.push(t));
              return n;
            }),
              ...
              for (var i = new m(), n = 0; n < e.length; n++) {
                ...
                if ('string' == typeof s)
                  try {
                    ...
                    try {
                      (s = this.defaults.amdLanguageBase + s), (o = m.loadPath(s));
                    } catch (e) {
                      t &&
                        window.console &&
                        console.warn &&
                ...
                else o = l.isPlainObject(s) ? new m(s) : s;
                i.extend(o);
              }
              return i;
            }),
          ...
          (e.prototype.fromElement = function (e) {
            ...
            for (var o = 0; o < e[0].attributes.length; o++) {
              var s = e[0].attributes[o].name,
                r = 'data-';
              s.substr(0, r.length) == r &&
                ((s = s.substring(r.length)),
                (r = d.GetData(e[0], s)),
                (i[s.replace(/-([a-z])/g, n)] = r));
            }
            c.fn.jquery &&
      ...
      d.define('select2/core', ['jquery', './options', './utils', './keys'], function (t, o, s, n) {
        function r(e, t) {
          ...
          var i = e.attr('tabindex') || 0,
            n =
              (s.StoreData(e[0], 'old-tabindex', i),
              e.attr('tabindex', '-1'),
        ...
        return (
          ...
          (r.prototype._resolveWidth = function (e, t) {
            var i,
              n = /^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i;
            if ('resolve' == t)
            ...
            this.on('open', function () {
              ...
              this.on('keypress', function (e) {
                ...
                i.isOpen()
                  ...
                  : (t === n.ENTER || t === n.SPACE || (t === n.DOWN && e.altKey)) &&
          ...
          (r.prototype._isChangeMutation = function (e) {
            ...
            if (e.addedNodes && 0 < e.addedNodes.length) {
              for (var i = 0; i < e.addedNodes.length; i++) if (e.addedNodes[i].selected) return !0;
            } else {
          ...
          (r.prototype.trigger = function (e, t) {
            ...
            if (
              (void 0 === t && (t = {}), e in n) &&
              (i.call(this, n[e], (n = { prevented: !1, name: e, args: t })), n.prevented)
            )
    ...
    function _(t, i) {
      return function () {
        ...
        return (
          'string' != typeof e[0] && 1 === e.length && e.push(null), r.apply(p, e.concat([t, i]))
        );
      };
    }
    function x(e) {
      var t;
      if ((b(g, e) && ((t = g[e]), delete g[e], (y[e] = !0), s.apply(p, t)), b(m, e) || b(y, e)))
        return m[e];
  ...
  (function (e) {
    ...
    (n = 0),
      ...
      (r.prototype.buildRows = function () {
        ...
        if (0 < n.options.rows) {
          for (
            i = n.options.slidesPerRow * n.options.rows, t = Math.ceil(s.length / i), e = 0;
            e < t;
            e++
          ) {
          ...
          null !== n
            ? (null !== s.activeBreakpoint && n === s.activeBreakpoint && !t) ||
              ...
              'unslick' === s.breakpointSettings[n]
                ? s.unslick(n)
                : ((s.options = c.extend({}, s.originalSettings, s.breakpointSettings[n])),
      ...
      (r.prototype.getSlideCount = function () {
        var i,
          n = this,
          o =
            !0 === n.options.centerMode ? n.slideWidth * Math.floor(n.options.slidesToShow / 2) : 0;
      ...
      (r.prototype.initDotEvents = function () {
        ...
        !0 === e.options.dots &&
          e.slideCount > e.options.slidesToShow &&
          (c('li', e.$dots).on('click.slick', { message: 'index' }, e.changeSlide),
        ...
        if (
          (!0 === s.options.centerMode
            ...
            : ((t = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide),
              ...
              !0 === s.options.fade && (0 < t && t--, i <= s.slideCount && i++)),
        ...
        for (
          ...
          if (
            ('object' == typeof i || void 0 === i
              ...
              : (e = t[s].slick[i].apply(t[s].slick, n)),
            void 0 !== e)
          )
            return e;
        return t;
  ...
  (function (e, t) {
    ...
    'use strict';
    return function (p, R, t, H) {
      function e() {
        return { x: 0, y: 0 };
      }
      function q(e, t) {
        g.extend(v, t.publicMethods), Ze.push(e);
      }
      function F(e) {
        var t = L();
      ...
      function j(e, t, i, n) {
        n === v.currItem.initialZoomLevel
          ? (i[e] = v.currItem.initialPosition[e])
          : ((i[e] = Je(e, n)),
            i[e] > t.min[e] ? (i[e] = t.min[e]) : i[e] < t.max[e] && (i[e] = t.max[e]));
      }
      function N(e) {
        var t = '';
        y.escKey && 27 === e.keyCode
          ...
          !t ||
            ...
            e.shiftKey ||
            e.metaKey ||
            (e.preventDefault ? e.preventDefault() : (e.returnValue = !1), v[t]());
      }
      function U(e) {
        e && (Ae || Ce || m || ke) && (e.preventDefault(), e.stopPropagation());
      }
      function W() {
      ...
      function Z(e) {
        ...
        ('mousedown' === e.type && 0 < e.button) ||
          (Jt
            ? e.preventDefault()
            : (Te && 'mousedown' === e.type) ||
              (It(e, !0) && e.preventDefault(),
              S('pointerDown'),
              pe &&
                ((t = g.arraySearch(mt, e.pointerId, 'id')) < 0 && (t = mt.length),
              ...
              !d &&
                ...
                C(ht, t[1]),
                Lt(E, ht, St),
                (xt.x = Math.abs(St.x) - w.x),
                (xt.y = Math.abs(St.y) - w.y),
                (Ie = Tt(E, ht)))));
      }
      function B(e) {
        var t;
        e.preventDefault(),
          pe &&
            -1 < (t = g.arraySearch(mt, e.pointerId, 'id')) &&
          ...
          l &&
            ...
            Le || Ae || d
              ...
              : D.x !== _.x * Ne
              ? (Le = 'h')
              : ((e = Math.abs(t[0].x - I.x) - Math.abs(t[0].y - I.y)),
                Math.abs(e) >= pt && ((Le = 0 < e ? 'h' : 'v'), (c = t))));
      }
      function G(e) {
        if (a.isOldAndroid) {
        ...
        S('pointerUp'),
          ...
          pe &&
            -1 < (s = g.arraySearch(mt, e.pointerId, 'id')) &&
            ((t = mt.splice(s, 1)[0]),
        ...
        if (
          (0 === i &&
            ((l = !1), g.unbind(window, J, v), $t(), d ? (s = 0) : -1 !== _t && (s = k() - _t)),
          (_t = 1 === i ? k() : -1),
          (e = -1 !== s && s < 150 ? 'zoom' : 'swipe'),
          d && i < 2 && ((d = !1), 1 === i && (e = 'zoomPointerUp'), S('zoomGestureEnded')),
          (c = null),
          Ae || Ce || m || ke)
        )
          if ((ct(), (xe = xe || Nt()).calculateSwipeSpeed('x'), ke))
            Pt() < y.verticalDragRange
              ? v.close()
              : ((n = w.y),
                (o = ze),
                dt('verticalDrag', 0, 1, 300, g.easing.cubic.out, function (e) {
                  (w.y = (v.currItem.initialPosition.y - n) * e + n), T((1 - o) * e + o), $();
                }),
                S('onVerticalDrag', 1));
          else {
            if ((Oe || m) && 0 === i) {
            ...
            m || ('swipe' !== e ? Bt() : !Oe && f > v.currItem.fitRatio && Ut(xe));
          }
      }
      var K,
        Y,
            ...
            for (
              var e,
                ...
                l =
                  ...
                  window.requestAnimationFrame &&
                    ((a.raf = window.requestAnimationFrame), (a.caf = window.cancelAnimationFrame)),
                  ...
                  a.pointerEvent ||
                    ...
                    1 <= (t = parseFloat(t)) &&
                      (t < 4.4 && (a.isOldAndroid = !0), (a.androidVersion = t)),
                    (a.isMobileOpera = /opera mini|opera mobi/i.test(e))),
              ...
              for (var r = c[d], u = 0; u < 3; u++)
                (i = l[u]),
                  (n = r + (r ? i.charAt(0).toUpperCase() + i.slice(1) : i)),
                  !a[i] && n in s && (a[i] = n);
              r &&
                !a.raf &&
                ((r = r.toLowerCase()),
        ...
        Ye = function (e, t, i, n, o) {
          (!Ge || (o && o !== v.currItem)) && (n /= (o || v.currItem).fitRatio),
            (e[ue] = ie + t + 'px, ' + i + 'px' + ne + ' scale(' + n + ')');
        },
        $ = function (e) {
          De &&
            (e &&
              (f > v.currItem.fitRatio
                ? Ge || (li(v.currItem, !1, !0), (Ge = !0))
                : Ge && (li(v.currItem), (Ge = !1))),
            Ye(De, w.x, w.y, f));
        },
        Xe = function (e) {
          e.container &&
            Ye(e.container.style, e.initialPosition.x, e.initialPosition.y, e.initialZoomLevel, e);
        },
        Ve = function (e, t) {
          t[ue] = ie + e + 'px, 0px' + ne;
        },
        Qe = function (e, t) {
          ...
          !y.loop &&
            ...
            (i = Math.round(e - D.x)),
            ((t < 0 && 0 < i) || (t >= L() - 1 && i < 0)) &&
              (e = D.x + i * y.mainScrollEndFriction)),
            (D.x = e),
            Ve(e, V);
        },
        Je = function (e, t) {
          var i = xt[e] - Ue[e];
          return je[e] + Fe[e] + i - (t / te) * i;
        },
        C = function (e, t) {
        ...
        it = function () {
          tt &&
            (g.unbind(document, 'mousemove', it),
        ...
        rt = 0,
        at = function (e) {
          A[e] && (A[e].raf && fe(A[e].raf), rt--, delete A[e]);
        },
        lt = function (e) {
          A[e] && at(e), A[e] || (rt++, (A[e] = {}));
        },
        ct = function () {
          for (var e in A) A.hasOwnProperty(e) && at(e);
        },
        dt = function (e, t, i, n, o, s, r) {
          function a() {
            if (A[e]) {
              if (((l = k() - c), n <= l)) return at(e), s(i), void (r && r());
              s((i - t) * o(l / n) + t), (A[e].raf = he(a));
            }
          }
          var l,
            c = k();
        ...
        H = {
          ...
          setScrollOffset: function (e, t) {
            (Ue.x = e), (ye = Ue.y = t), S('updateScrollOffset', Ue);
          },
          ...
          init: function () {
            if (!K && !Y) {
              (v.framework = g),
                (v.template = p),
                (v.bg = g.getChildByClass(p, 'pswp__bg')),
                (me = p.className),
                (K = !0),
                (a = g.detectFeatures()),
                (he = a.raf),
                ...
                (ue = a.transform),
                (ve = a.oldIE),
                (v.scrollWrap = g.getChildByClass(p, 'pswp__scroll-wrap')),
                (v.container = g.getChildByClass(v.scrollWrap, 'pswp__container')),
                (V = v.container.style),
                (v.itemHolders = r =
                  [
                    { el: v.container.children[0], wrap: 0, index: -1 },
                    { el: v.container.children[1], wrap: 0, index: -1 },
                    { el: v.container.children[2], wrap: 0, index: -1 },
                  ]),
                ...
                !(function () {
                  ...
                  (ue = 'left'),
                    ...
                    ($ = function () {
                      ...
                      De &&
                        ((e = De),
                        (i = (n = 1 < (t = v.currItem).fitRatio ? 1 : t.fitRatio) * t.w),
                        (n = n * t.h),
                        (e.width = i + 'px'),
                        (e.height = n + 'px'),
                        (e.left = w.x + 'px'),
              ...
              R && (v.ui = new R(v, g)).init(),
                ...
                y.modal &&
                  (We
                    ...
                    : ((p.style.position = 'absolute'), (p.style.top = g.getScrollY() + 'px'))),
                void 0 === ye && (S('initialLayout'), (ye = ge = g.getScrollY()));
              t = 'pswp--open ';
              for (
                ...
                Ve((e + Q) * _.x, r[e].el.style);
              ve || g.bind(v.scrollWrap, ee, v),
                s('initialZoomInEnd', function () {
                  v.setContent(r[0], h - 1),
                    v.setContent(r[2], h + 1),
                    (r[0].el.style.display = r[2].el.style.display = 'block'),
                    y.focus && p.focus(),
                    g.bind(document, 'keydown', v),
                    a.transform && g.bind(v.scrollWrap, 'click', v),
                    y.mouseUsed || g.bind(document, 'mousemove', it),
                    g.bind(window, 'resize scroll orientationchange', v),
                    S('bindEvents');
                }),
                v.setContent(r[1], h),
                v.updateCurrItem(),
                ...
                We ||
                  (oe = setInterval(function () {
                    rt || l || d || f !== v.currItem.initialZoomLevel || v.updateSize();
                  }, 1e3)),
          ...
          close: function () {
            K &&
              ((Y = !(K = !1)),
              S('close'),
              g.unbind(window, 'resize scroll orientationchange', v),
              g.unbind(window, 'scroll', i.scroll),
              g.unbind(document, 'keydown', v),
              g.unbind(document, 'mousemove', it),
              a.transform && g.unbind(v.scrollWrap, 'click', v),
              l && g.unbind(window, J, v),
              clearTimeout(we),
              S('unbindEvents'),
              ti(v.currItem, null, !0, v.destroy));
          },
          destroy: function () {
            S('destroy'),
              Xt && clearTimeout(Xt),
              ...
              (p.className = me),
              oe && clearInterval(oe),
              g.unbind(v.scrollWrap, ee, v),
              g.unbind(window, 'scroll', v),
              $t(),
              ct(),
              (Ke = null);
          },
          panTo: function (e, t, i) {
            i ||
              (e > u.min.x ? (e = u.min.x) : e < u.max.x && (e = u.max.x),
              t > u.min.y ? (t = u.min.y) : t < u.max.y && (t = u.max.y)),
              (w.x = e),
              (w.y = t),
              $();
          },
          ...
          updateCurrZoomItem: function (e) {
            var t;
            e && S('beforeChange', 0),
              (De = r[1].el.children.length
                ? ((t = r[1].el.children[0]), g.hasClass(t, 'pswp__zoom-wrap') ? t.style : null)
                : null),
              (u = v.currItem.bounds),
              (te = f = v.currItem.initialZoomLevel),
              (w.x = u.center.x),
              (w.y = u.center.y),
              e && S('afterChange');
          },
              ...
              if (!(e && i < 2)) {
                ...
                for (var n = 0; n < i; n++)
                  0 < x
                    ? ((t = r.shift()),
                      (r[2] = t),
                      Ve((++Q + 2) * _.x, t.el.style),
                      v.setContent(t, h - i + n + 1 + 1))
                    : ((t = r.pop()),
                      r.unshift(t),
                      Ve(--Q * _.x, t.el.style),
                      v.setContent(t, h + i - n - 1 - 1));
                !De ||
                  1 !== Math.abs(x) ||
                  ((e = ei(re)).initialZoomLevel !== f && (ri(e, b), li(e), Xe(e))),
                  (x = 0),
                  v.updateCurrZoomItem(),
                  (re = h),
                  S('afterChange');
              }
            }
          ...
          updateSize: function (e) {
            ...
            if (
              ((b.x = v.scrollWrap.clientWidth),
              (b.y = v.scrollWrap.clientHeight),
              W(),
              (_.x = b.x + Math.round(b.x * y.spacing)),
              (_.y = b.y),
              Qe(_.x * Ne),
              S('beforeResize'),
              void 0 !== Q)
              ...
              for (var i, n, o, s = 0; s < 3; s++)
                (i = r[s]),
                  Ve((s + Q) * _.x, i.el.style),
                  (o = h + s - 1),
                  y.loop && 2 < L() && (o = F(o)),
                  (n = ei(o)) && (se || n.needsUpdate || !n.bounds)
                    ? (v.cleanSlide(n),
                      v.setContent(i, o),
                      1 === s && ((v.currItem = n), v.updateCurrZoomItem(!0)),
                      (n.needsUpdate = !1))
                    : -1 === i.index && 0 <= o && v.setContent(i, o),
                  n && n.container && (ri(n, b), li(n), Xe(n));
              se = !1;
            }
            (te = f = v.currItem.initialZoomLevel),
              (u = v.currItem.bounds) && ((w.x = u.center.x), (w.y = u.center.y), $(!0)),
              S('resize');
          },
          zoomTo: function (t, e, i, n, o) {
            e && ((te = f), (xt.x = Math.abs(e.x) - w.x), (xt.y = Math.abs(e.y) - w.y), C(je, w));
            function s(e) {
              1 === e
                ? ((f = t), (w.x = r.x), (w.y = r.y))
                : ((f = (t - a) * e + a),
        ...
        At = function () {
          return !('fit' === y.scaleMode && f === v.currItem.initialZoomLevel);
        },
        Et = function (e, t) {
          return (
            !(!e || e === document) &&
        ...
        It = function (e, t) {
          return (
            (Ot.prevent = !Et(e.target, y.isClickableElement)),
        ...
        Mt = function (e, t, i) {
          var n;
          50 < e - _e &&
            (((n = 2 < vt.length ? vt.shift() : {}).x = t), (n.y = i), vt.push(n), (_e = e));
        },
        Pt = function () {
        ...
        qt = function (e) {
          ...
          return (
            pe
              ...
              ? e.touches &&
                0 < e.touches.length &&
                ((Ht[0] = Dt(e.touches[0], zt)),
                1 < e.touches.length && (Ht[1] = Dt(e.touches[1], Rt)))
              : ((zt.x = e.pageX), (zt.y = e.pageY), (zt.id = ''), (Ht[0] = zt)),
            Ht
          );
        },
        Ft = function (e, t) {
          var i,
            ...
            a = D.x + t.x,
            l = D.x - gt.x,
            c = s > u.min[e] || s < u.max[e] ? y.panEndFriction : 1,
            s = w[e] + t[e] * c;
          if (
            (y.allowPanToNext || f === v.currItem.initialZoomLevel) &&
            (De
              ? 'h' !== Le ||
                'x' !== e ||
                Ce ||
                (r
                  ? (s > u.min[e] && ((c = y.panEndFriction), u.min[e], (i = u.min[e] - je[e])),
                    (i <= 0 || l < 0) && 1 < L()
                      ? ((o = a), l < 0 && a > gt.x && (o = gt.x))
                      : u.min.x !== u.max.x && (n = s))
                  : (s < u.max[e] && ((c = y.panEndFriction), u.max[e], (i = je[e] - u.max[e])),
                    (i <= 0 || 0 < l) && 1 < L()
            ...
            return (
              void 0 !== o && (Qe(o, !0), (Oe = o !== gt.x)),
              u.min.x !== u.max.x && (void 0 !== n ? (w.x = n) : Oe || (w.x += t.x * c)),
              void 0 !== o
            );
          m || Oe || (f > v.currItem.fitRatio && (w[e] += t[e] * c));
        },
        jt = function () {
          if (c) {
            var e,
              ...
              s = c.length;
            if (0 !== s)
              if ((C(E, c[0]), (O.x = E.x - I.x), (O.y = E.y - I.y), d && 1 < s))
                (I.x = E.x),
                  (I.y = E.y),
                  (!O.x && !O.y && kt(c[1], ht)) ||
                    (C(ht, c[1]),
                    Ce || ((Ce = !0), S('zoomGestureStarted')),
                    (s = Tt(E, ht)),
                    (e = Zt(s)) > v.currItem.initialZoomLevel + v.currItem.initialZoomLevel / 15 &&
                      (Re = !0),
                    (t = 1),
                    (i = ot()),
                    (n = st()),
                    e < i
                      ? y.pinchToClose && !Re && te <= v.currItem.initialZoomLevel
                        ? (T((o = 1 - (i - e) / (i / 1.2))), S('onPinchClose', o), (Pe = !0))
                        : (e = i - (t = 1 < (t = (i - e) / i) ? 1 : t) * (i / 3))
                      : n < e && (e = n + (t = 1 < (t = (e - n) / (6 * i)) ? 1 : t) * i),
                    t < 0 && (t = 0),
                    Lt(E, ht, bt),
                    (Fe.x += bt.x - St.x),
                    (Fe.y += bt.y - St.y),
                ...
                (Me &&
                  ((Me = !1),
                  Math.abs(O.x) >= pt && (O.x -= c[0].x - ft.x),
                  Math.abs(O.y) >= pt && (O.y -= c[0].y - ft.y)),
                (I.x = E.x),
                (I.y = E.y),
                0 !== O.x || 0 !== O.y)
              ) {
                if ('v' === Le && y.closeOnVerticalDrag)
                  if (!At())
                    return (
                      (Fe.y += O.y),
                      (w.y += O.y),
          ...
          var t,
            ...
            n = {
              ...
              calculateSwipeSpeed: function (e) {
                (i =
                  1 < vt.length
                    ? ((t = k() - _e + 50), vt[vt.length - 2][e])
                    : ((t = k() - be), ft[e])),
                  (n.lastFlickOffset[e] = I[e] - i),
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                n.backAnimStarted[t] ||
                  (w[t] > u.min[t]
                    ? (n.backAnimDestination[t] = u.min[t])
                    : w[t] < u.max[t] && (n.backAnimDestination[t] = u.max[t]),
              ...
              calculateAnimOffset: function (e) {
                n.backAnimStarted[e] ||
                  ...
                  (w[e] += n.distanceOffset[e]));
              },
              panAnimLoop: function () {
                A.zoomPan &&
                  ((A.zoomPan.raf = he(n.panAnimLoop)),
                  (n.now = k()),
                  ...
                  n.speedDecelerationRatioAbs.x < 0.05 &&
                    ...
                    ((w.x = Math.round(w.x)), (w.y = Math.round(w.y)), $(), at('zoomPan')));
              },
            };
          return n;
        },
        Ut = function (e) {
          ...
          lt('zoomPan'), (e.lastNow = k()), e.panAnimLoop();
        },
        Wt = function (e, t) {
          m || (wt = h),
            'swipe' === e &&
              ...
              ut < e && (s || 20 < t.lastFlickOffset.x)
                ? (n = -1)
                : e < -ut && (s || t.lastFlickOffset.x < -20) && (n = 1)),
            n &&
              ((h += n) < 0
                ? ((h = y.loop ? L() - 1 : 0), (o = !0))
                : h >= L() && ((h = y.loop ? 0 : L() - 1), (o = !0)),
              (o && !y.loop) || ((x += n), (Ne -= n), (i = !0)));
          var i,
            n,
            o,
            e = _.x * Ne,
            s = Math.abs(e - D.x),
            r =
              i || e > D.x == 0 < t.lastFlickSpeed.x
                ? ((r = 0 < Math.abs(t.lastFlickSpeed.x) ? s / Math.abs(t.lastFlickSpeed.x) : 333),
                  (r = Math.min(r, 400)),
                  Math.max(r, 250))
                : 333;
          return (
            ...
            dt('mainScroll', D.x, e, r, g.easing.cubic.out, Qe, function () {
              ct(),
                (m = !1),
                (wt = -1),
                (!i && wt === h) || v.updateCurrItem(),
                S('mainScrollAnimComplete');
            }),
            i && v.updateCurrItem(!0),
            i
          );
        },
        Zt = function (e) {
          ...
          return (
            Pe && !Se && !Re && f < i
              ...
              : (Pe &&
                ...
                v.zoomTo(t, 0, 200, g.easing.cubic.out, e)),
            !0
          );
        };
      q('Gestures', {
          ...
          initGestures: function () {
            ...
            (pe = a.pointerEvent) && a.touch && (a.touch = !1),
              pe
                ...
                : a.touch
                ? (e('touch', 'start', 'move', 'end', 'cancel'), (n = !0))
                : e('mouse', 'down', 'move', 'up'),
              (J = le + ' ' + ce + ' ' + de),
              (ee = ae),
              pe && !n && (n = 1 < navigator.maxTouchPoints || 1 < navigator.msMaxTouchPoints),
              (v.likelyTouchDevice = n),
              (i[ae] = Z),
              (i[le] = B),
              (i[ce] = G),
              de && (i[de] = i[ce]),
      ...
      function Yt() {
        if (ii.length) {
          for (var e, t = 0; t < ii.length; t++)
            (e = ii[t]).holder.index === e.index &&
              ai(e.index, e.item, e.baseDiv, e.img, !1, e.clearPlaceholder);
          ii = [];
        }
      }
      var Xt,
        ...
        ti = function (s, e, r, t) {
          function a() {
            at('initialZoom'),
              r
                ? (v.template.removeAttribute('style'), v.bg.removeAttribute('style'))
                : (T(1),
          ...
          Xt && clearTimeout(Xt),
            ...
            s.initialLayout
              ...
              : (l = y.getThumbBoundsFn && y.getThumbBoundsFn(h));
          var l,
            c = r ? y.hideAnimationDuration : y.showAnimationDuration;
          if (!c || !l || void 0 === l.x)
            return (
              S('initialZoom' + (r ? 'Out' : 'In')),
              (f = s.initialZoomLevel),
              C(w, s.initialPosition),
              $(),
          ...
          var d, u;
          (d = X),
            (u = !v.currItem.src || v.currItem.loadError || y.showHideOpacity),
            s.miniImg && (s.miniImg.style.webkitBackfaceVisibility = 'hidden'),
            r ||
              ((f = l.w / s.w),
              (w.x = l.x),
              (w.y = l.y - ge),
              (v[u ? 'template' : 'bg'].style.opacity = 0.001),
              $()),
            lt('initialZoom'),
            r && !d && g.removeClass(p, 'pswp--animated-in'),
            u &&
              (r
                ? g[(d ? 'remove' : 'add') + 'Class'](p, 'pswp--animate_opacity')
                : setTimeout(function () {
                ...
                S('initialZoom' + (r ? 'Out' : 'In')),
                  r
                    ? ((t = l.w / s.w),
                      ...
                      (e = function (e) {
                        1 === e
                          ? ((f = t), (w.x = l.x), (w.y = l.y - ye))
                          : ((f = (t - n) * e + n),
                            (w.x = (l.x - i.x) * e + i.x),
                            (w.y = (l.y - ye - i.y) * e + i.y)),
                          $(),
                          u ? (p.style.opacity = 1 - e) : T(o - e * o);
                      }),
                      d
                        ? dt('initialZoom', 0, 1, c, g.easing.cubic.out, e, a)
                        : (e(1), (Xt = setTimeout(a, c + 20))))
                    : ((f = s.initialZoomLevel),
                      C(w, s.initialPosition),
                      $(),
                      T(1),
                      u ? (p.style.opacity = 1) : T(1),
                      (Xt = setTimeout(a, c + 20)));
              },
              r ? 25 : 90,
            ));
        },
        ...
        si = function (e, t, i) {
          var n = e.bounds;
          (n.center.x = Math.round((M.x - t) / 2)),
            (n.center.y = Math.round((M.y - i) / 2) + e.vGap.top),
            (n.max.x = t > M.x ? Math.round(M.x - t) : n.center.x),
            (n.max.y = i > M.y ? Math.round(M.y - i) + e.vGap.top : n.center.y),
            (n.min.x = t > M.x ? 0 : n.center.x),
            (n.min.y = i > M.y ? e.vGap.top : n.center.y);
        },
        ri = function (e, t, i) {
          ...
          var n,
            o = !i;
          return (
            o && (e.vGap || (e.vGap = { top: 0, bottom: 0 }), S('parseVerticalMargin', e)),
            (M.x = t.x),
            ...
            o &&
              ...
              (n = M.y / e.h),
              (e.fitRatio = t < n ? t : n),
              'orig' === (t = y.scaleMode) ? (i = 1) : 'fit' === t && (i = e.fitRatio),
              (e.initialZoomLevel = i = 1 < i ? 1 : i),
              e.bounds || (e.bounds = oi())),
            i
              ? (si(e, e.w * i, e.h * i),
        ...
        ai = function (e, t, i, n, o, s) {
          t.loadError ||
            (n &&
              ((t.imageAppended = !0),
              li(t, n, t === v.currItem && Ge),
              i.appendChild(n),
              s &&
                setTimeout(function () {
                  t &&
        ...
        li = function (e, t, i) {
          ...
          e.src &&
            ...
            e.placeholder &&
              !e.loaded &&
              ((e.placeholder.style.width = n + 'px'), (e.placeholder.style.height = i + 'px')),
            (t.style.width = n + 'px'),
            (t.style.height = i + 'px'));
        };
      q('Controller', {
        publicMethods: {
          lazyLoadItem: function (e) {
            e = F(e);
            var t = ei(e);
            t && ((!t.loaded && !t.loading) || se) && (S('gettingData', e, t), t.src && Gt(t));
          },
            ...
            g.extend(y, ni, !0),
              ...
              s('beforeChange', function (e) {
                for (
                  ...
                  v.lazyLoadItem(h + s);
                for (s = 1; s <= (i ? n : o); s++) v.lazyLoadItem(h - s);
              }),
              s('initialLayout', function () {
                v.currItem.initialLayout = y.getThumbBoundsFn && y.getThumbBoundsFn(h);
              }),
              s('mainScrollAnimComplete', Yt),
              s('initialZoomInEnd', Yt),
              s('destroy', function () {
          ...
          getItemAt: function (e) {
            return 0 <= e && void 0 !== Vt[e] && Vt[e];
          },
          allowProgressiveImg: function () {
            return y.forceProgressiveLoading || !n || y.mouseUsed || 1200 < screen.width;
          },
          setContent: function (t, i) {
            ...
            var e,
              n,
              o,
              s = v.getItemAt(t.index),
              s = (s && (s.container = null), v.getItemAt(i));
            s
              ? (S('gettingData', i, s),
                (t.index = i),
                (n = (t.item = s).container = g.createEl('pswp__zoom-wrap')),
                !s.src &&
                  s.html &&
                  (s.html.tagName ? n.appendChild(s.html) : (n.innerHTML = s.html)),
                Kt(s),
                ri(s, b),
                !s.src || s.loadError || s.loaded
                  ? s.src &&
                    !s.loadError &&
                    (((e = g.createEl('pswp__img', 'img')).style.opacity = 1),
                    (e.src = s.src),
                    li(s, e),
                    ai(i, s, n, e, !0))
                        ...
                        if (t && t.index === i) {
                          if (Kt(e, !0))
                            return (
                              ...
                              ri(e, b),
                              Xe(e),
                              void (t.index === h && v.updateCurrZoomItem())
                            );
                          e.imageAppended
                            ? !Jt &&
                              e.placeholder &&
                            ...
                            : ai(i, e, n, e.img, m || Jt, !0);
                        }
                        (e.loadComplete = null), (e.img = null), S('imageLoadComplete', i, e);
                      }
                    }),
                    g.features.transform &&
                      ((o = 'pswp__img pswp__img--placeholder'),
                      (o += s.msrc ? '' : ' pswp__img--placeholder--blank'),
                      (o = g.createEl(o, s.msrc ? 'img' : '')),
                      s.msrc && (o.src = s.msrc),
                      li(s, o),
                      n.appendChild(o),
                      (s.placeholder = o)),
                    s.loading || Gt(s),
                    v.allowProgressiveImg() &&
                      (!Qt && a.transform
                        ? ii.push({ item: s, baseDiv: n, img: s.img, index: i, holder: t })
                        : ai(i, s, n, s.img, !0, !0))),
                Qt || i !== h ? Xe(s) : ((De = n.style), ti(s, e || s.img)),
                (t.el.innerHTML = ''),
                t.el.appendChild(n))
              : (t.el.innerHTML = '');
          },
      ...
      function ci(e, t, i) {
        var n = document.createEvent('CustomEvent'),
          t = { origEvent: e, target: e.target, releasePoint: t, pointerType: i || 'touch' };
      ...
      function ui() {
        ...
        for (s = 0; s < n.length; s++)
          n[s] && ((i = n[s].split('=')).length < 2 || (t[i[0]] = i[1]));
        if (y.galleryPIDs) {
          for (var o = t.pid, s = (t.pid = 0); s < Vt.length; s++)
            if (Vt[s].pid === o) {
              t.pid = s;
              break;
            }
      ...
      var pi,
        ...
        ki =
          (q('Tap', {
            publicMethods: {
              initTap: function () {
                s('firstTouchStart', v.onTapStart),
                  s('touchRelease', v.onTapRelease),
                  s('destroy', function () {
                    (Si = {}), (pi = null);
                  });
              },
              ...
              onTapRelease: function (e, t) {
                ...
                !t ||
                  ...
                  (n = i),
                  (o = Si),
                  Math.abs(n.x - o.x) < qe && Math.abs(n.y - o.y) < qe)
                    ? S('doubleTap', i)
                    : 'mouse' === t.type
                    ? ci(e, t, 'mouse')
                    : 'BUTTON' === e.target.tagName.toUpperCase() ||
                      g.hasClass(e.target, 'pswp__single-tap')
                    ? ci(e, t)
                    : (C(Si, i),
            ...
            publicMethods: {
              ...
              setupDesktopZoom: function (e) {
                ...
                s('bindEvents', function () {
                  g.bind(p, t, v.handleMouseWheel);
                }),
                  s('unbindEvents', function () {
                    P && g.unbind(p, t, v.handleMouseWheel);
                  }),
                  (v.mouseZoomedIn = !1);
                function i() {
                  v.mouseZoomedIn && (g.removeClass(p, 'pswp--zoomed-in'), (v.mouseZoomedIn = !1)),
                    f < 1
                      ? g.addClass(p, 'pswp--zoom-allowed')
                      : g.removeClass(p, 'pswp--zoom-allowed'),
                    o();
                }
                var n,
                  o = function () {
                    n && (g.removeClass(p, 'pswp--dragging'), (n = !1));
                  };
                s('resize', i),
                  s('afterChange', i),
                  s('pointerDown', function () {
                    v.mouseZoomedIn && ((n = !0), g.addClass(p, 'pswp--dragging'));
                  }),
                  s('pointerUp', o),
                  e || i();
              },
              handleMouseWheel: function (e) {
                if (f <= v.currItem.fitRatio)
                  return (
                    y.modal &&
                      (!y.closeOnScroll || rt || l
                        ? e.preventDefault()
                        : ue && 2 < Math.abs(e.deltaY) && ((X = !0), v.close())),
                    !0
                  );
                if ((e.stopPropagation(), (P.x = 0), 'deltaX' in e))
                  ...
                  e.wheelDeltaX && (P.x = -0.16 * e.wheelDeltaX),
                    e.wheelDeltaY ? (P.y = -0.16 * e.wheelDeltaY) : (P.y = -0.16 * e.wheelDelta);
                else {
                ...
                var t = w.x - P.x,
                  i = w.y - P.y;
                (y.modal || (t <= u.min.x && t >= u.max.x && i <= u.min.y && i >= u.max.y)) &&
                  e.preventDefault(),
                  v.panTo(t, i);
              },
              toggleDesktopZoom: function (e) {
                e = e || { x: b.x / 2 + Ue.x, y: b.y / 2 + Ue.y };
                var t = y.getDoubleTapZoom(!0, v.currItem),
                  i = f === t;
                (v.mouseZoomedIn = !i),
                  v.zoomTo(i ? v.currItem.initialZoomLevel : t, e, 333),
                  g[(i ? 'remove' : 'add') + 'Class'](p, 'pswp--zoomed-in');
              },
            },
          }),
          ...
          mi && clearTimeout(mi),
            rt || l
              ...
              : (gi ? clearTimeout(fi) : (gi = !0),
                (t = h + 1),
                (e = ei(h)).hasOwnProperty('pid') && (t = e.pid),
                (e = o + '&gid=' + y.galleryUID + '&pid=' + t),
                wi || (-1 === z.hash.indexOf(e) && (_i = !0)),
                (t = z.href.split('#')[0] + '#' + e),
                xi
                  ? '#' + e !== window.location.hash &&
                    history[wi ? 'replaceState' : 'pushState']('', document.title, t)
                  : wi
                  ? z.replace(t)
                  : (z.hash = e),
                (wi = !0),
            ...
            g.extend(y, ki, !0),
              y.history &&
                  ...
                  (yi = !0),
                    bi ||
                      (_i
                        ...
                        ? (z.hash = o)
                        : xi
                        ? history.pushState('', document.title, z.pathname + z.search)
                        : (z.hash = '')),
                    di();
                }),
                s('unbindEvents', function () {
                ...
                -1 < (t = o.indexOf('pid=')) &&
                  ...
                  (o = o.slice(0, -1)),
                setTimeout(function () {
                  K && g.bind(window, 'hashchange', v.onHashChange);
                }, 40));
          },
          onHashChange: function () {
            if (Ti() === o) return (bi = !0), void v.close();
            gi || ((vi = !0), v.goTo(ui().pid), (vi = !1));
          },
          updateURL: function () {
            di(), vi || (wi ? (hi = setTimeout($i, 800)) : $i());
          },
        },
      }),
        g.extend(v, H);
  ...
  (function (e, t) {
    ...
    return function (n, a) {
      function e(e) {
        ...
        for (
          var t, i, n = (e.target || e.srcElement).getAttribute('class') || '', o = 0;
          o < P.length;
          o++
        )
          (t = P[o]).onTap && -1 < n.indexOf('pswp__' + t.name) && (t.onTap(), (i = !0));
        i &&
      ...
      function i() {
        ...
        e !== k && (L(h, 'ui--one-slide', e), (k = e));
      }
      function r() {
        L(v, 'share-modal--hidden', D);
      }
      function o() {
        if (
          ((D = !D)
            ...
            : (r(),
              setTimeout(function () {
                D || a.addClass(v, 'pswp__share-modal--fade-in');
              }, 30)),
          !D)
        ) {
          for (var e, t, i, n, o = '', s = 0; s < T.shareButtons.length; s++) {
            e = T.shareButtons[s];
            ...
            o +=
              ...
              e.label +
              '</a>';
            if (T.parseShareButtonOut) o = T.parseShareButtonOut(e, o);
          }
          (v.children[0].innerHTML = o), (v.children[0].onclick = H);
        }
      }
      function s(e) {
      ...
      function l() {
        clearTimeout(A), (M = 0), w && E.setIdle(!1);
      }
      function c(e) {
      ...
      function d(e) {
        x !== e && (L(_, 'preloader--active', !e), (x = e));
      }
      function u(e) {
        var t,
          i = e.vGap;
        !n.likelyTouchDevice || T.mouseUsed || screen.width > T.fitControlsWidth
          ? ((t = T.barsSize),
            T.captionEl && 'auto' === t.bottom
              ? (m ||
                  ((m = a.createEl('pswp__caption pswp__caption--fake')).appendChild(
                    a.createEl('pswp__caption__center'),
                  ),
                  h.insertBefore(m, f),
                  a.addClass(h, 'pswp__ui--fit')),
                T.addCaptionHTMLFn(e, m, !0)
                  ? ((e = m.clientHeight), (i.bottom = parseInt(e, 10) || 44))
                  : (i.bottom = t.top))
              ...
              for (var n = 0; n < P.length; n++)
                (r = P[n]),
                  -1 < s.indexOf('pswp__' + r.name) &&
                    (T[r.option]
                      ? (a.removeClass(o, 'pswp__element--disabled'), r.onInit && r.onInit(o))
      ...
      (E.init = function () {
        ...
        a.extend(n.options, R, !0),
          ...
          (b = n.listen)('onVerticalDrag', function (e) {
            I && e < 0.95 ? E.hideControls() : !I && 0.95 <= e && E.showControls();
          }),
          b('onPinchClose', function (e) {
            I && e < 0.9 ? (E.hideControls(), (t = !0)) : t && !I && 0.9 < e && E.showControls();
          }),
          b('zoomGestureEnded', function () {
            (t = !1) && !I && E.showControls();
          }),
          b('beforeChange', E.update),
          b('doubleTap', function (e) {
            var t = n.currItem.initialZoomLevel;
            n.getZoomLevel() !== t
              ? n.zoomTo(t, e, 333)
              : n.zoomTo(T.getDoubleTapZoom(!1, n.currItem), e, 333);
          }),
          ...
          b('bindEvents', function () {
            a.bind(h, 'pswpTap click', e),
              a.bind(n.scrollWrap, 'pswpTap', E.onGlobalTap),
              n.likelyTouchDevice || a.bind(n.scrollWrap, 'mouseover', E.onMouseOver);
          }),
          b('unbindEvents', function () {
            D || o(),
              ...
              p &&
                (a.unbind(document, p.eventK, E.updateFullscreen),
                p.isFullscreen() && ((T.hideAnimationDuration = 0), p.exit()),
                (p = null));
          }),
          b('destroy', function () {
            T.captionEl && (m && h.removeChild(m), a.removeClass(f, 'pswp__caption--empty')),
          ...
          T.fullscreenEl &&
            ...
            ((p = p || E.getFullscreenAPI())
              ? (a.bind(document, p.eventK, E.updateFullscreen),
                E.updateFullscreen(),
        ...
        (E.update = function () {
          (O =
            !(!I || !n.currItem) &&
            (E.updateIndexIndicator(),
            T.captionEl &&
              (T.addCaptionHTMLFn(n.currItem, f), L(f, 'caption--empty', !n.currItem.title)),
            !0)),
            D || o(),
            i();
        }),
        (E.updateFullscreen = function (e) {
          e &&
            ...
            a[(p.isFullscreen() ? 'add' : 'remove') + 'Class'](n.template, 'pswp--fs');
        }),
        (E.updateIndexIndicator = function () {
          T.counterEl &&
            (t.innerHTML = n.getCurrentIndex() + 1 + T.indexIndicatorSep + T.getNumItemsFn());
        }),
            ...
            (e.detail && 'mouse' === e.detail.pointerType
              ? s(t)
                ...
                : a.hasClass(t, 'pswp__img') &&
                  (1 === n.getZoomLevel() && n.getZoomLevel() <= n.currItem.fitRatio
                    ? T.clickToCloseNonZoomable && n.close()
                    : n.toggleDesktopZoom(e.detail.releasePoint))
              : (T.tapToToggleControls && (I ? E.hideControls() : E.showControls()),
                T.tapToClose && (a.hasClass(t, 'pswp__img') || s(t)) && n.close()));
        }),
        (E.onMouseOver = function (e) {
          e = (e = e || window.event).target || e.srcElement;
          L(h, 'ui--over-close', s(e));
        }),
        (E.hideControls = function () {
          a.addClass(h, 'pswp__ui--hidden'), (I = !1);
        }),
        (E.showControls = function () {
          (I = !0), O || E.update(), a.removeClass(h, 'pswp__ui--hidden');
        }),
  ...
  document.addEventListener('DOMContentLoaded', function () {
    {
      const h = document.querySelector('body'),
        f = document.querySelector('.js-header__opener');
      h &&
        f &&
        f.addEventListener('click', function () {
          this.classList.contains('is-open')
            ? (h.classList.remove('is-nav-open'), this.classList.remove('is-open'))
            : (h.classList.add('is-nav-open'), this.classList.add('is-open'));
        });
    }
    var i, e, t, n, o, s;
    function r() {
    ...
    $('.js-gallery').length &&
          ...
          t =
            ...
            e.find('a').each(function () {
              var e = $(this).attr('href'),
                t = $(this).data('size').split('x'),
                i = t[0],
                t = t[1];
              n.push({ src: e, w: i, h: t });
            }),
            n);
        e.on('click', 'figure', function (e) {
          e.preventDefault();
          e = $(this).parent().index();
          new PhotoSwipe(i, PhotoSwipeUI_Default, t, {
            index: e,
            bgOpacity: 0.7,
            showHideOpacity: !0,
          }).init();
      ...
      $('.partners-slider').slick({
        ...
        autoplay: !0,
        responsive: [
          { breakpoint: 1201, settings: { slidesToShow: 4, slidesToScroll: 4 } },
          { breakpoint: 750, settings: { slidesToShow: 3, slidesToScroll: 3 } },
          { breakpoint: 570, settings: { slidesToShow: 2, slidesToScroll: 2 } },
        ],
      }),
      $('.c-topstory-section__inner').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        autoplay: true,
        autoplaySpeed: 5000,
        ...
        dots: false,
        prevArrow:
          '<button class="topstory__btn topstory__btnprev"><img src="./images/ico/slider.svg" loading="lazy" alt="" /></button> ',
        nextArrow:
          ' <button class="topstory__btn  topstory__btnnext"><img src="./images/ico/slider.svg" loading="lazy" alt="" /></button>',
        responsive: [
          {
            breakpoint: 741, // ⬅️ 640px и меньше
            settings: 'unslick', // ⬅️ отключить slick
          },
        ],
      }),
      (t = document.getElementById('basket_bar_esports')),
      (n = 0),
      (o = document.getElementById('basket_bar_esports').getAttribute('data-competition')),
      document.getElementById('basket_bar_esports').getAttribute('data-idTeam'),
      document.getElementById('basket_bar_esports').getAttribute('data-googleSearch'),
      (s = 'https://vesna.esports.cz/weby_data/top_bar'),
      '2liga' != o &&
        ((e = '<div id="top_bar_icons">'), (e += '    <div class="top_bar_icons_logo">')),
      '1liga' == o &&
        (e =
          (e =
            (e =
                          ...
                          (e =
                            (e =
                              (e =
                                ...
                                '      <span class="top_bar_icons_logo__divider"></span>\t\t\t\t<a href="https://basketbrno.cz/" target="_blank" title="Basket Brno (' +
                                r() +
                                '.)"><img src="' +
                                s +
      ...
      (t.innerHTML = e);
    var a,
      l = document.querySelectorAll('.o-content table');
    for (a = 0; a < l.length; ++a) {
      l[a].classList.add('table');
      var c = document.createElement('div');
      c.classList.add('table-responsive'),
        l[a].parentNode.insertBefore(c, l[a]),
        c.appendChild(l[a]);
    }
    var d,
      u = document.querySelectorAll('.o-content iframe');
    for (d = 0; d < u.length; ++d) {
      u[d].removeAttribute('height'), u[d].removeAttribute('width');
      var p = document.createElement('div');
      p.classList.add('ratio'),
        p.classList.add('ratio-16x9'),
        u[d].parentNode.insertBefore(p, u[d]),
        p.appendChild(u[d]);
    }
        ...
        $('a[data-gallery]').click(function () {
          ...
          if (!n)
            return (
              ...
              (e = $(this).data('gallery')),
              (t = $(this).data('start')),
              (i = '/inc/gallery-ajax.php?mode=' + e),
              (1 != e && 2 != e && 3 != e) || (i += '&id=' + $(this).data('gallery-id')),
